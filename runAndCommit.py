...
from bodyMeasurements import bodyMeasurements, credentials
    ...
    try:
        while True:
            if strftime('%H:%M') == triggerTime or triggerNow:
                ...
                system('git add BodyMeasurementsTimeSeries.pdf')
...
def grabInputArgs():
    parser = ArgumentParser(description='Run bodyMeasurements daily and push '
                                        'results to Github')
